...
import {IMG_LOGO_COMPANY_LOGIN, IMG_LOGO_LOGIN, IMG_LOGO_PRODUCT_LOGIN} from '../../../assets/path';
...
function SignInView(props) {
    ...
    return (<KeyboardAwareScrollView style={styles.containerScroll} showsVerticalScrollIndicator={false}>
            <Image
