import {COLOR_DARK_PRIMARY, COLOR_THIRTY, COLOR_WHITE} from 'constants/colors';
import {
...
export default StyleSheet.create({
    container: {
        ...
        color: `#A5CE36`, lineHeight: scaleLandscape(21),
        width: DEVICE_WIDTH - scaleLandscape(40),
    }, dateText: {
        alignSelf: 'flex-start',
        marginTop: scaleLandscape(9),
    }, statusText: {
        paddingVertical: DEFAULT_PADDING_VERTICAL / 2, textDecorationLine: 'underline',
    }, image: {
        ...
        color: `#0C7131`, lineHeight: scaleLandscape(21),
        width: DEVICE_WIDTH - scaleLandscape(40),
    }
});
