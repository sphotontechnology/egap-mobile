...
import {
    COLOR_BACKGROUND, COLOR_TEXT_PRIMARY, COLOR_GRAY_TEXT, COLOR_DARK_PRIMARY,
} from 'constants/colors';
import {
    BORDER_RADIUS, DEFAULT_PADDING_HORIZONTAL, DEFAULT_PADDING_VERTICAL, ICON_SIZE,
} from 'constants/size';
...
export default StyleSheet.create({
    container: {
        ...
        fontSize: ICON_SIZE.SMALL, color: `rgba(131, 131, 131, 1)`,
    }, label: {
        color: COLOR_TEXT_PRIMARY, fontSize: FONT_SIZE.SMALL,
    }, underline: {height: 1, backgroundColor: 'black', width: '100%'}, inputView: {
        flexDirection: 'row',
        alignItems: 'center',
